...
mergedEmail_df = pd.concat([WDmergeEM, WDmergePN, WDmergeWDID, BEWDIDNA])
...
mergedEmail_df = mergedEmail_df[['EID_M', 'EID_AM',
                                 'WDID_M','WDID_AM',
                                 'FirstName_M', 'FirstName_AM', 'FirstName_BE', 
                                 'LastName_M', 'LastName_AM', 'LastName_BE', 
                                 'MiddleName_BE', 
                                 'Phone_M', 'Phone_AM', 'Phone_BE', 
                                 'Email_M', 'Email_AM', 'Email_BE', 
                                 'Class_M', 'Class_AM', 'Class_BE', 
                                 'Specialty_M', 'Specialty_AM', 'Specialty_BE',
                                 'DOB_M', 'DOB_BE', 
                                 'Gender_AM', 'Gender_BE', 
                                 'Address_M', 'Address_BE', 
                                 'City_M', 'City_AM', 'City_BE', 
                                 'State_M', 'State_AM', 'State_BE', 
                                 'Zip_M', 'Zip_AM', 'Zip_BE', 
                                 'LicenseState_AM', 'LicenseState_BE',
                                 'LicenseNumber_BE', 
                                 'SS#_BE', 
                                 'AlertMedia Updated', 'Mobilize Updated', 'Backend Updated', 
                                 'Completed By', 'DATE COMPLETED', 'Notes', 'Address Line 2', 'ProfileActive_M']]
